...
return new class extends Migration
{
    ...
    {
        Schema::create('marketing_pencairan_simpanan_kumulatif', function (Blueprint $table) {
            ...
            $table->string('metode_pembayaran', 2);
    ...
    {
        Schema::dropIfExists('marketing_pencairan_simpanan_kumulatif');
    }
};
