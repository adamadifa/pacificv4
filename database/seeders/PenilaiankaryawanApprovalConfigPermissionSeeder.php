...
class PenilaiankaryawanApprovalConfigPermissionSeeder extends Seeder
{
    /**
    ...
    {
        // Cari atau buat Permission Group "Penilaian Karyawan"
        ...
        $permissions = [
            'penilaiankaryawan.config.index',
            'penilaiankaryawan.config.create',
            'penilaiankaryawan.config.edit',
            'penilaiankaryawan.config.delete',
        ];
        ...
        $this->command->info('Permissions for Config Approval successfully created and assigned.');
    }
}
