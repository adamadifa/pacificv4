...
class RepackgudangcabangController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('gudangcabang.repack.index', $data);
    }
    ...
    public function create()
    {
        ...
        $cabang = $cbg->getCabang();
        $data['cabang'] = $cabang;
        return view('gudangcabang.repack.create', $data);
    }
    ...
    public function edit($no_mutasi)
    {
        ...
        $data['repack'] = Mutasigudangcabang::select(
            'no_mutasi',
            'tanggal',
        ...
        $cabang = $cbg->getCabang();
        $data['cabang'] = $cabang;
        return view('gudangcabang.repack.edit', $data);
    }
    ...
    public function update($no_mutasi, Request $request)
    {
        ...
        try {
            ...
            //Checking
            $cektutuplaporan_repack = cektutupLaporan($repack->tanggal, "gudangcabang");
            if ($cektutuplaporan_repack > 0) {
                return Redirect::back()->with(messageError('Periode Laporan Sudah Ditutup !'));
            }
    ...
    public function show($no_mutasi)
    {
        ...
        $data['detail'] = Detailmutasigudangcabang::select('gudang_cabang_mutasi_detail.kode_produk', 'nama_produk', 'jumlah', 'isi_pcs_dus', 'isi_pcs_pack')
            ...
            ->where('no_mutasi', $no_mutasi)
            ->get();
        return view('gudangcabang.repack.show', $data);
    }
