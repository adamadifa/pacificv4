    ...
    public function store(Request $request)
    {
        ...
        if ($user->hasRole($roles_show_cabang)) {
            ...
            $request->validate([
                ...
                'file_persediaan' => 'required|mimes:pdf,png,jpg,jpeg|max:500',
                'file_kas_kecil' => 'required|mimes:pdf,png,jpg,jpeg|max:500',
                'file_kas_besar' => 'required|mimes:pdf,png,jpg,jpeg|max:500',
            ]);
        } else {
