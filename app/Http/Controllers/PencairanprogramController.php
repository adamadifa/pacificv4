...
class PencairanprogramController extends Controller
{
    ...
    public function getpelanggan(Request $request)
    {
        ...
        $detailpenjualan = Detailpenjualan::select(
            ...
            DB::raw('(SELECT diskon FROM produk_diskon WHERE SUN(floor(marketing_penjualan_detail.jumlah/produk.isi_pcs_dus)) BETWEEN produk_diskon.min_qty AND produk_diskon.max_qty AND kode_kategori_diskon="' . $kategori_diskon . '") as diskon'),
