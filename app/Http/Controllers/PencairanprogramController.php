...
class PencairanprogramController extends Controller
{
    ...
    public function detailfaktur($kode_pelanggan, $kode_pencairan, $top)
    {
        ...
        $detailpenjualan = Detailpenjualan::select(
            ...
            DB::raw('SUM(floor(jumlah/isi_pcs_dus)) * (SELECT diskon FROM produk_diskon WHERE floor(marketing_penjualan_detail.jumlah/produk.isi_pcs_dus) BETWEEN produk_diskon.min_qty AND produk_diskon.max_qty AND kode_kategori_diskon="' . $kategori_diskon . '") as diskon_reguler'),
