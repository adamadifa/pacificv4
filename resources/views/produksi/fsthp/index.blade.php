            ...
            <div class="row">
                <div class="col-lg-10 col-sm-12 col-md-12">
                    <x-input-with-icon label="Tanggal Mutasi" value="{{ Request('tanggal_mutasi_search') }}"
                        name="tanggal_mutasi_search" icon="ti ti-calendar" datepicker="flatpickr-date" />
                </div>
                            ...
                            <td>
                                <div class="d-flex">
                                    ...
                                    @can('fsthp.approve')
                                        @if ($d->status !== '1')
                                            <div>
                                                <a href="{{ route('fsthp.approve', Crypt::encrypt($d->no_mutasi)) }}"
                                                    class="me-1">
