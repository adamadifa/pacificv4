            ...
            <a href="{{ route('ajuanfaktur.index', ['posisi_ajuan' => $level_user, 'status' => 0]) }}">
                <div class="card card-border-shadow-warning h-100">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-2">
                            <div class="avatar me-4">
                                <span class="avatar-initial rounded bg-label-warning"><i class="ti ti-file-invoice ti-28px"></i></span>
                            </div>
            ...
            <a href="{{ route('penilaiankaryawan.index', ['posisi_ajuan' => $level_user, 'status' => 'pending']) }}">
                <div class="card card-border-shadow-info h-100">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-2">
                            <div class="avatar me-4">
                                <span class="avatar-initial rounded bg-label-info"><i class="ti ti-users ti-28px"></i></span>
                            </div>
        ...
        <div class="col-12 mb-2">
            <div class="card card-border-shadow-success h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-2">
                        <div class="avatar me-4">
                            <span class="avatar-initial rounded bg-label-success"><i class="ti ti-target-arrow ti-28px"></i></span>
                        </div>
                ...
                <div class="card-body">
                    <form action="#" id="formRekappenjualan">
                        @hasanyrole($roles_show_cabang)
                            <x-select label="Cabang" name="kode_cabang_rekappenjualan" :data="$cabang" key="kode_cabang" textShow="nama_cabang"
                        ...
                        <div class="form-group mb-3">
                            <button class="btn btn-primary w-100" id="btnRekappenjualan"><i class="ti ti-eye me-1"></i>Tampilkan</button>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="#" id="formAup">
                        ...
                        @endhasanyrole
                        <x-input-with-icon label="Lihat per Tanggal" name="tanggal" icon="ti ti-calendar" datepicker="flatpickr-date" />
                        <div class="form-group mb-3">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="#" id="formRekapkendaraan">
                        @hasanyrole($roles_show_cabang)
                            <x-select label="Cabang" name="kode_cabang_rekapkendaraan" :data="$cabang" key="kode_cabang" textShow="nama_cabang"
                        ...
                        <div class="form-group mb-3">
                            <button class="btn btn-primary w-100" id="btnRekapkendaraan"><i class="ti ti-eye me-1"></i>Tampilkan</button>
                        </div>
                    </form>
                </div>
            </div>
            <div class="col-lg-12 col-md-12 col-sm-12 mt-2" id="loadrekappersediaan"></div>
        </div>
    </div>
