    ...
    <div class="row">
        <div class="col d-flex justify-content-between">
            <div class="btn-group" role="group" aria-label="First group">
                ...
                <a href="{{ route('sfa.capture', Crypt::encrypt($pelanggan->kode_pelanggan)) }}"
                    class="btn btn-primary waves-effect text-white p-2">
                ...
                <div class="card p-0 m-0">
                    <div class="card-content p-0">
                        ...
                        <div class="card-img-overlay" style="background-color: #00000097;">
                            ...
                            <p class="card-text text-white m-0">Limit Pelanggan : {{ formatAngka($pelanggan->limit_pelanggan) }}
                            </p>
                            <p class="card-text text-white m-0">Jumlah Faktur Max :
                                {{ $ajuanfaktur != null ? $ajuanfaktur->jumlah_faktur : 0 }}</p>
                            @php
    ...
    <div class="row mt-3 mb-3">
        ...
        @else
            @if (!empty(Cookie::get('kodepelanggan')))
                @if (Crypt::decrypt(Cookie::get('kodepelanggan')) == $pelanggan->kode_pelanggan)
                    <div class="col-6">
                        <a href="/sfa/penjualan/create" class="btn btn-primary w-100"><i
                                class="ti ti-shopping-bag me-1"></i>Penjualan</a>
                    </div>
                    <div class="col-6">
        ...
        <ul class="nav nav-tabs nav-fill" role="tablist">
            <li class="nav-item" role="presentation">
                <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab" data-bs-target="#penjualan"
                    aria-controls="penjualan" aria-selected="true">
                    Penjualan
                </button>
            </li>
            <li class="nav-item" role="presentation">
