                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                                            ...
                                            <tbody id="loadproduk">
                                                ...
                                                @foreach ($detail as $d)
                                                    @php
                                                        ...
                                                        $jml_pack = $jml[1];
                                                        $jml_pcs = $jml[2];
                                                        $subtotal_dus = $jml_dus * $d->harga_dus;
                                                        $subtotal_pack = $jml_pack * $d->harga_pack;
                                                        $subtotal_pcs = $jml_pcs * $d->harga_pcs;
                                                        $subtotal += $d->subtotal;
                                                    ...
                                                    @endphp
                                                    <tr class="{{ $color_row }} index_{{ $index }}">
                                                        <td style="background-color: {{ $colorproduk }}">
                                                            ...
                                                            <input type="hidden" name="isi_pcs_dus_produk[]" value="{{ $d->isi_pcs_dus }}" />
                                                            <input type="hidden" name="isi_pcs_pack_produk[]" value="{{ $d->isi_pcs_pack }}" />
                                                            <input type="hidden" name="jumlah_dus[]" class="jumlah_dus"
                                                                value="{{ $jml_dus }}" />
                                                            <input type="hidden" name="harga_dus_produk[]" value="{{ $d->harga_dus }}" />
                                                            <input type="hidden" name="harga_pack_produk[]" value="{{ $d->harga_pack }}" />
                                                            <input type="hidden" name="harga_pcs_produk[]" value="{{ $d->harga_pcs }}" />
                                                            <input type="hidden" name="subtotal[]" class="subtotal"
                                                                value="{{ $d->subtotal }}" />
                                                            {{ $d->nama_produk }}
                                                    ...
                                                    @if (!empty($jml_dus))
                                                        <tr class="{{ $color_row }} index_{{ $index }}">
                                                            <td>
                                                                {{ $jml_dus }} Dus x {{ formatAngka($d->harga_dus) }}
                                                            </td>
                                                            <td class="text-end fw-bold">
                                                                {{ formatAngka($subtotal_dus) }}
                                                            </td>
                                                        </tr>
                                                    @endif
                                                    @if (!empty($jml_pack))
                                                        <tr class="{{ $color_row }} index_{{ $index }}">
                                                            <td>
                                                                {{ $jml_pack }} Pack x {{ formatAngka($d->harga_pack) }}
                                                            </td>
                                                            <td class="text-end fw-bold">
                                                                {{ formatAngka($subtotal_pack) }}
                                                            </td>
                                                        </tr>
                                                    @endif
                                                    @if (!empty($jml_pcs))
                                                        <tr class="{{ $color_row }} index_{{ $index }}">
                                                            <td>
                                                                {{ $jml_pcs }} Pcs x {{ formatAngka($d->harga_pcs) }}
                                                            </td>
                                                            <td class="text-end fw-bold">
                                                                {{ formatAngka($subtotal_pcs) }}
                                                            </td>
                                                        </tr>
                                                    @endif
                                                @endforeach
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-lg-3 col-sm-12 d-none d-none">
                                    <div class="row">
                                        <div class="col">
                                            <div class="divider text-start divider-primary">
                                                <div class="divider-text" style="font-size: 1rem">
                                ...
                                <div class="col-lg-3 col-sm-12">
                                    ...
                                    <div class="row" id="jenis_bayar_tunai">
                                        <div class="col">
                                            <div class="form-group mb-3">
                                                <select name="jenis_bayar" id="jenis_bayar" class="form-select" disabled>
