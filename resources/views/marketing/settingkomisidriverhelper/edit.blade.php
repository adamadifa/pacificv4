<form action="{{ route('settingkomisidriverhelper.update', ['kode_komisi' => Crypto::encrypt($settingkomisidriverhelper->id)]) }}" method="POST"
    id="formSettingkomisi">
    <div class="row">
        <div class="co-12">
            @csrf
            @method('PUT')
            ...
            <x-input-with-icon-label icon="ti ti-moneybag" label="Komisi Salesman" name="komisi_salesman" align="right" money="true"
                :value="formatAngka($settingkomisidriverhelper->komisi_salesman)" />
            <x-input-with-icon-label icon="ti ti-file-description" label="Qty Flat" name="qty_flat" align="right" :value="formatAngka($settingkomisidriverhelper->qty_flat)" />
            <x-input-with-icon-label icon="ti ti-file-description" label="UMK" name="umk" align="right" :value="formatAngka($settingkomisidriverhelper->umk)" />
            <x-input-with-icon-label icon="ti ti-file-description" label="Persentase" name="persentase" align="right" :value="formatAngka($settingkomisidriverhelper->persentase)" />
        </div>
    </div>
