@extends('layouts.app')
@section('titlepage', 'S.A Piutang Sales')

@section('content')
@section('navigasi')
    <div class="d-flex justify-content-between align-items-center">
        <div>
            <h4 class="mb-0">S.A Piutang Sales</h4>
            <small class="text-muted">Mengelola data saldo awal piutang salesman.</small>
        </div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0" style="font-size: 13px">
                ...
                <li class="breadcrumb-item active"><i class="ti ti-database-import me-1"></i>S.A Piutang Sales</li>
            </ol>
        </nav>
    </div>
@endsection
...
<div class="row">
    <div class="col-lg-8 col-md-12 col-sm-12">
        {{-- Filter Section --}}
        <form action="{{ route('sapiutangsales.index') }}">
        ...
        <div class="card shadow-sm border">
            <div class="card-header border-bottom py-3"
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    @can('sapiutangsales.create')
                        <a href="{{ route('sapiutangsales.create') }}" class="btn btn-primary btn-sm shadow-sm">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center gap-2">
                                        ...
                                        @endcan
                                        @can('sapiutangsales.delete')
                                            <form method="POST" name="deleteform" class="deleteform d-inline"
                                                action="{{ route('sapiutangsales.delete', Crypt::encrypt($d->kode_saldo_awal)) }}">
                                                @csrf
                                                @method('DELETE')
...
<x-modal-form id="modal" size="modal-xl" show="loadmodal" title="Detail Saldo Awal" />
@endsection
...
<script>
   $(function() {
      $(".showSaldoawal").click(function(e) {
         ...
         e.preventDefault();
         $('#modal').modal("show");
         $("#loadmodal").load('/sapiutangsales/' + kode_saldo_awal + '/show');
      });
   });
</script>
@endpush
