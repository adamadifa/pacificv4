@extends('layouts.app')
@section('titlepage', 'Buat S.A Piutang Sales')

@section('content')
@section('navigasi')
    <span class="text-muted fw-light">S.A Piutang Sales /</span> Buat Saldo Awal
@endsection

<div class="row">
    <div class="col-lg-10 col-md-12 col-sm-12 col-xs-12">
        <form action="{{ route('sapiutangsales.store') }}" method="POST" id="formCreatesaldoawal">
            @csrf
            ...
            <div class="card shadow-sm border mb-3">
                <div class="card-header border-bottom py-2" style="background-color: #002e65; border-radius: 0.375rem 0.375rem 0 0;">
                    <h6 class="m-0 fw-bold text-white" style="font-size: 0.85rem;"><i class="ti ti-calendar me-2"></i>Pilih Periode & Cabang</h6>
                </div>
                <div class="card-body">
            ...
            <div class="card shadow-sm border">
                <div class="card-header border-bottom py-2" style="background-color: #002e65; border-radius: 0.375rem 0.375rem 0 0;">
                    <h6 class="m-0 fw-bold text-white" style="font-size: 0.85rem;"><i class="ti ti-list me-2"></i>Rincian Saldo Akhir Piutang Sales</h6>
                </div>
                    ...
                    <div class="table-responsive" style="max-height: 50vh; overflow-y: auto;">
                        <table class="table table-bordered table-striped table-sm mb-0">
                            <thead class="sticky-top">
                                <tr>
                                    <th style="background-color: #002e65; color: white;">Kode Sales</th>
                                    <th style="background-color: #002e65; color: white;">Nama Salesman</th>
    ...
    $(function() {
        ...
        function loaddetailsaldo() {
            ...
            if (bulan == "") {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('sapiutangsales.getdetailsaldo') }}",
                    data: {
                        _token: "{{ csrf_token() }}",
                        bulan: bulan,
                        tahun: tahun,
                    ...
                    cache: false,
                    beforeSend: function() {
                        $("#loaddetailsaldo").html('<tr><td colspan="3" class="text-center"><div class="spinner-border spinner-border-sm text-primary" role="status"><span class="visually-hidden">Loading...</span></div> Memuat data...</td></tr>');
                    },
        ...
        $("#formCreatesaldoawal").submit(function(e) {
            ...
            let data = [];
            $('.saldo_akhir').each(function() {
                let kode_salesman = $(this).closest('tr').find('.kode_salesman').val();
                let saldo_akhir = $(this).val();
                data.push({
