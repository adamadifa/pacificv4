<form action="{{ route('pembayarangiro.storegroup') }}" method="POST" id="formCreategrouptransfer">
   @csrf
   <x-input-with-icon label="Auto" icon="ti ti-barcode" disabled="true" name="kode_giro" />
   <x-input-with-icon label="Tanggal" icon="ti ti-calendar" datepicker="flatpickr-date" name="tanggal" />
   <div class="input-group mb-3">
      <input type="text" class="form-control" name="kode_pelanggan" id="kode_pelanggan" readonly
         placeholder="Kode Pelanggan" aria-label="Kode Pelanggan" aria-describedby="kode_pelanggan_search">
      <a class="btn btn-primary waves-effect" id="kode_pelanggan_search"><i
...
<script>
   $(function() {
      const form = $("#formCreategrouptransfer");
      ...
      form.submit(function() {
         ...
         const no_giro = form.find("#no_giro").val();
