                  ...
                  <div class="col-12">
                     <form action="{{ route('ajuanlimit.index') }}">
                        ...
                        <div class="row">
                           <div class="col">
                              <div class="form-group mb-3">
                                 <button class="btn btn-primary w-100"><i class="ti ti-search me-2"></i>Cari Data</button>
                              </div>
                                    ...
                                    <td>
                                       <div class="d-flex">
                                          ...
                                          @can('ajuanlimit.edit')
                                             ...
                                             @elseif (
                                                 ...
                                                 (in_array($level_user, $roles_approve_ajuanlimitkredit) && $d->status_disposisi == '0') ||
                                                     (in_array($level_user, $roles_approve_ajuanlimitkredit) && $d->id_pengirim == auth()->user()->id && $d->status_ajuan == '0'))
                                                <div>
                                                   <a href="#" class="me-2 btnEdit"
                                                      no_pengajuan="{{ Crypt::encrypt($d->no_pengajuan) }}">
                                                      <i class="ti ti-edit text-success"></i>
                                          ...
                                          @can('ajuanlimit.delete')
                                             @if (($d->id_pengirim == auth()->user()->id && $d->status == '0') || ($level_user == 'operation manager' && $d->role == 'sales marketing manager' && $d->status_ajuan == '0'))
                                                <div>
                                                   <form method="POST" name="deleteform"
                                                      class="deleteform"
