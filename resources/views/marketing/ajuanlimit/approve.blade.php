<form action="{{ route('ajuanlimit.approvestore', Crypt::encrypt($ajuanlimit->no_pengajuan)) }}" id="formApprovelimit"
    method="POST">
    @csrf
    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12">
                            <div class="form-group mb-3">
                                @if (auth()->user()->roles->pluck('name')[0] == 'sales marketing manager' ||
                                        auth()->user()->roles->pluck('name')[0] == 'operation manager')
                                ...
                                @else
                                    <button class="btn btn-primary w-100" name="approve" type="submit"><i
                                            class="ti ti-thumb-up me-1"></i>Setuju </button>
                                @endif
                            </div>
                        </div>
            ...
            <div class="row mb-3">
                <div class="col">
                    @foreach ($disposisi as $index => $d)
                        @if ($index === 0 && $d->role == 'sales marketing manager')
                            @php
                                continue;
                            @endphp
                        @endif
