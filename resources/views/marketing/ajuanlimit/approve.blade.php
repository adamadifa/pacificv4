<form action="{{ route('ajuanlimit.approvestore', Crypt::encrypt($ajuanlimit->no_pengajuan)) }}" id="formApprovelimit" method="POST">
   ...
   <div class="row">
      <div class="col-lg-6 col-md-12 col-sm-12">
         ...
         <div class="row mt-3">
            <div class="col">
               @if (auth()->user()->roles->pluck('name')[0] == 'sales marketing manager' && $ajuanlimit->jumlah > 5000000)
         ...
         <div class="row mb-3">
            <div class="col">
               <table class="table mb-2">
                  ...
                  <tr>
                     <th>Type Outlet</th>
                     <td>{{ !empty($ajuanlimit->type_outlet) ? $type_outlet[$ajuanlimit->type_outlet] : '' }}</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                     ...
                     <td>{{ !empty($ajuanlimit->topup_terakhir) ? DateToIndo($ajuanlimit->topup_terakhir) : '' }}</td>
                  </tr>
                  <tr>
                     <th>Omset Toko</th>
                     ...
                     <td>
                        @php
                           if ($ajuanlimit->skor <= 2) {
                               ...
                               $$ajuanlimit->skor = 'Layak Dengan Pertimbangan';
