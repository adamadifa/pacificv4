   ...
   <div class="row">
      <div class="col-lg-5 col-md-12 col-sm-12">
         ...
         <div class="input-group mb-3">
            <input type="text" class="form-control" name="kode_pelanggan" id="kode_pelanggan" readonly placeholder="Kode Pelanggan" aria-label="Kode Pelanggan"
               aria-describedby="kode_pelanggan_search">
...
<script>
   $(function() {
         ...
         $.ajax({
            ...
            success: function(response) {
               ...
               if (status_aktif_pelanggan === '0') {
                  ...
                  form.find("#lokasi").val(response.data.latitude + "," + response.data.longitude);
      ...
      $("#status_outlet,#type_outlet,#ljt,#cara_pembayaran,#kepemilikan,#lama_topup,#lama_langganan,#lama_berjualan,#jaminan,#histori_transaksi").change(function() {
         loadSkor();
      });
      ...
      function loadSkor() {
         ...
         let totalscore = parseFloat(score_outlet) + parseFloat(score_top) + parseFloat(score_carabayar) + parseFloat(score_kepemilikan) + parseFloat(score_lamausaha) + parseFloat(
               score_jaminan) +
