...
@section('navigasi')
    <div class="d-flex justify-content-between align-items-center">
        <div>
            ...
            <small class="text-muted">Ubah alur approval untuk rentang nominal terpilih.</small>
        </div>
...
<div class="row">
    <div class="col-md-8">
        <form action="{{ route('ajuanlimitconfig.update', $config->id) }}" method="POST">
            @csrf
            @method('PUT')
                ...
                <div class="card-body mt-3">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="min_limit" class="form-control money" placeholder="0" value="{{ number_format($config->min_limit, 0, ',', '.') }}" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Maksimal Nominal</label>
                            <input type="text" name="max_limit" class="form-control money" placeholder="0" value="{{ number_format($config->max_limit, 0, ',', '.') }}" required>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card shadow-sm border">
                ...
                <div class="card-body mt-3">
                    <div id="role-container">
                        @foreach ($config->roles as $selected_role)
