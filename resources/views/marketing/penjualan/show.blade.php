...
<div class="row">
   <div class="col-xl-3 col-lg-5 col-md-5">
         ...
         <div class="card-body">
            ...
            <ul class="list-unstyled mb-4 mt-3">
               ...
               <li class="d-flex align-items-center mb-1">
                  <i class="ti ti-map-pin text-heading"></i><span class="fw-medium mx-2 text-heading">Alamat Pelanggan:</span>
               </li>
               <li class="d-flex align-items-center mb-3">
      ...
      @if (Storage::disk('public')->exists('/signature/' . $penjualan->signature) && !empty($penjualan->signature))
         <div class="card">
            <div class="card-body">
               <img src="{{ getSignature($penjualan->signature) }}" alt="user image"
                  class="m-auto" height="150" width="300">
            </div>
         </div>
      @endif
      <!--/ About User -->
                     ...
                     <table class="table table-bordered">
                        ...
                        <tfoot class="table-dark">
                           ...
                           <tr>
                              ...
                              <td class="text-end">{{ formatAngka($subtotal_retur - $subtotal_retur_gb) }}</td>
                           </tr>
                        </tfoot>
                     </table>
                  </div>
                              ...
                              <tr>
                                 ...
                                 <td>
                                    ...
                                    @elseif ($d->giro_to_cash == '1')
                                       <span class="badge bg-success">Ganti Giro Ke Cash {{ $d->no_giro }}</span>
                                    @endif
                                 ...
                                 <td>
                                    <div class="d-flex">
                                       @if ($d->jenis_bayar == 'TP' || $d->jenis_bayar == 'TN')
                           ...
                           @foreach ($giro as $d)
                              <tr>
                                 ...
                                 <td class="text-center">
                                    ...
                                    @elseif ($d->status == '1')
                                       <span class="badge bg-success">Diterima {{ date('d-m-y', strtotime($d->tanggal_diterima)) }}</span>
                                    @elseif ($d->status == '2')
                                       <span class="badge bg-danger">Ditolak {{ date('d-m-y', strtotime($d->tanggal_ditolak)) }}</span>
                                    @endif
                                 </td>
                                 <td>{{ $d->nama_salesman }}</td>
                                 <td>
