...
<div class="row">
    <div class="col-xl-3 col-lg-5 col-md-5">
        ...
        @if (Storage::disk('public')->exists('/signature/' . $penjualan->signature) && !empty($penjualan->signature))
            <div class="card">
                <div class="card-body">
                    <img src="{{ getSignature($penjualan->signature) }}" alt="user image" class="m-auto"
                ...
                <div class="row mb-2 mt-3">
                    <div class="col">
                        @can('pembayaranpenjualan.create')
                            <a href="#" class="btn btn-primary" id="btnCreateBayar"><i
                                    class="ti ti-plus me-1"></i>Input Pembayaran</a>
                        @endcan
                    </div>
                </div>
                <div class="row mt-2">
                ...
                <div class="row mb-2 mt-3">
                    <div class="col">
                        @can('pembayarangiro.create')
                            <a href="#" class="btn btn-primary" id="btnCreategiro"><i
                ...
                <div class="row mb-2 mt-3">
                    <div class="col">
                        @can('pembayarantransfer.create')
                            <a href="#" class="btn btn-primary" id="btnCreatetransfer"><i
                                    class="ti ti-plus me-1"></i>Input Transfer</a>
                        @endcan
                    </div>
                </div>
                <div class="row mt-2">
