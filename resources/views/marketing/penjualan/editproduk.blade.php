      ...
      <select name="kode_harga" id="kode_harga" class="form-select" disabled>
         ...
         @foreach ($harga as $d)
            <option data-isi_pcs_dus = "{{ $d->isi_pcs_dus }}" data-isi_pcs_pack = "{{ $d->isi_pcs_pack }}"
               data-harga_dus = "{{ formatAngka($d->harga_dus) }}"
               data-harga_pack = "{{ formatAngka($d->harga_pack) }}"
               data-harga_pcs = "{{ formatAngka($d->harga_pcs) }}"
               data-kode_kategori_diskon = "{{ $d->kode_kategori_diskon }}"
   ...
   <div class="row mb-2">
      <div class="col-12">
         <div class="form-check mb-2">
            <input class="form-check-input status_promosi_edit" name="status_promosi_edit" value="1"
               type="checkbox" id="status_promosi_edit"
