...
<script type="text/javascript">
   $(document).ready(function() {
         ...
         if (kode_harga == "") {
            ...
            let produk = `
                    <tr id="index_${index}" class="${bgcolor}">
                        <td>
                            <input type="hidden" name="kode_harga[]" value="${kode_harga}" class="kode_harga"/>
      ...
      $(document).on('submit', '#formEditproduk', function(e) {
         ...
         let jumlah = (jmldus * parseInt(isi_pcs_dus)) + (jmlpack * (parseInt(isi_pcs_pack))) + jmlpcs;
         ...
         let newRow = `
                    <tr id="index_${index}" class="${bgcolor}">
                        <td>
                            <input type="hidden" name="kode_harga[]" value="${kode_harga}" class="kode_harga"/>
                            <input type="hidden" name="status_promosi[]" value="${status_promosi}" class="status_promosi"/>
                            <input type="hidden" name="kode_kategori_diskon[]" class="kode_kategori_diskon" value="${kode_kategori_diskon}"/>
                            ${kode_harga}
                        </td>
                        <td>${nama_produk}</td>
