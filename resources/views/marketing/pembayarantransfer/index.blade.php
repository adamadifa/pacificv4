                                    ...
                                    <td>
                                       <div class="d-flex">
                                          @can('pembayarantransfer.approve')
                                             <div>
                                                <a href="#" class="btnApprove me-2" kode_transfer="{{ Crypt::encrypt($d->kode_transfer) }}"><i class="ti ti-external-link text-success"></i></a>
                                             </div>
                                          @endcan
                                          @can('pembayarantransfer.show')
                                             <div>
                                                <a href="#" class="btnShow" kode_transfer="{{ Crypt::encrypt($d->kode_transfer) }}"><i class="ti ti-file-description text-info"></i></a>
                                             </div>
                                          @endcan
