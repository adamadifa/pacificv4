        ...
        <div class="col-lg-10 col-md-12 col-12">
            <div class="nav-align-left mb-4 shadow-none">
                <ul class="nav nav-tabs" role="tablist">
                    @can('mkt.penjualan')
                        <li class="nav-item" role="presentation">
                            <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab"
                                data-bs-target="#penjualan" aria-controls="penjualan" aria-selected="false" tabindex="-1">
                    ...
                    @can('mkt.rekappenjualan')
                        <li class="nav-item" role="presentation">
                            <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                                data-bs-target="#rekappenjualan" aria-controls="rekappenjualan" aria-selected="false"
                                tabindex="-1">
                    ...
                    @can('mkt.retur')
                        <li class="nav-item" role="presentation">
                            <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#retur"
                                aria-controls="retur" aria-selected="false" tabindex="-1">
                    ...
                    @can('mkt.kartupiutang')
                        <li class="nav-item" role="presentation">
                            <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                                data-bs-target="#kartupiutang" aria-controls="kartupiutang" aria-selected="false" tabindex="-1">
                    ...
                    @can('mkt.aup')
                        <li class="nav-item" role="presentation">
                            <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#aup"
                                aria-controls="aup" aria-selected="false" tabindex="-1">
                    ...
                    @can('mkt.lebihsatufaktur')
                        <li class="nav-item" role="presentation">
                            <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                                data-bs-target="#lebihsatufaktur" aria-controls="lebihsatufaktur" aria-selected="false"
                                tabindex="-1">
                    ...
                    @can('mkt.dpp')
                        <li class="nav-item" role="presentation">
                            <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#dpp"
                                aria-controls="dpp" aria-selected="false" tabindex="-1">
                    ...
                    @can('mkt.dppp')
                        <li class="nav-item" role="presentation">
                            <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#dppp"
                                aria-controls="dppp" aria-selected="false" tabindex="-1">
                    ...
                    @can('mkt.omsetpelanggan')
                        <li class="nav-item" role="presentation">
                            <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                                data-bs-target="#omsetpelanggan" aria-controls="omsetpelanggan" aria-selected="false"
                                tabindex="-1">
                    ...
                    @can('mkt.rekappelanggan')
                        <li class="nav-item" role="presentation">
                            <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                                data-bs-target="#rekappelanggan" aria-controls="rekappelanggan" aria-selected="false"
                                tabindex="-1">
                    ...
                    @can('mkt.rekapkendaraan')
                        <li class="nav-item" role="presentation">
                            <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                                data-bs-target="#rekapkendaraan" aria-controls="rekapkendaraan" aria-selected="false"
                                tabindex="-1">
                    ...
                    @can('mkt.rekapwilayah')
                        <li class="nav-item" role="presentation">
                            <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                                data-bs-target="#rekapwilayah" aria-controls="rekapwilayah" aria-selected="false" tabindex="-1">
                    ...
                    @can('mkt.analisatransaksi')
                        <li class="nav-item" role="presentation">
                            <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                                data-bs-target="#analisatransaksi" aria-controls="analisatransaksi" aria-selected="false"
                                tabindex="-1">
                    ...
                    @can('mkt.tunaitransfer')
                        <li class="nav-item" role="presentation">
                            <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                                data-bs-target="#tunaitransfer" aria-controls="tunaitransfer" aria-selected="false"
                                tabindex="-1">
                    ...
                    @can('mkt.effectivecall')
                        <li class="nav-item" role="presentation">
                            <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                                data-bs-target="#effectivecall" aria-controls="effectivecall" aria-selected="false"
                                tabindex="-1">
                    ...
                    @can('mkt.lhp')
                        <li class="nav-item" role="presentation">
                            <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#lhp"
                                aria-controls="lhp" aria-selected="false" tabindex="-1">
                    ...
                    @can('mkt.routingsalesman')
                        <li class="nav-item" role="presentation">
                            <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                                data-bs-target="#routingsalesman" aria-controls="routingsalesman" aria-selected="false"
                                tabindex="-1">
                    ...
                    @can('mkt.salesperfomance')
                        <li class="nav-item" role="presentation">
                            <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                                data-bs-target="#salesperfomance" aria-controls="salesperfomance" aria-selected="false"
                                tabindex="-1">
                    ...
                    @can('mkt.persentasesfa')
                        <li class="nav-item" role="presentation">
                            <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                                data-bs-target="#persentasesfa" aria-controls="persentasesfa" aria-selected="false"
                                tabindex="-1">
                    ...
                    @can('mkt.persentasesfa')
                        <li class="nav-item" role="presentation">
                            <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                                data-bs-target="#persentasedatapelanggan" aria-controls="persentasedatapelanggan"
                    ...
                    @can('mkt.komisisalesman')
                        <li class="nav-item" role="presentation">
                            <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                                data-bs-target="#komisisalesman" aria-controls="komisisalesman" aria-selected="false"
                                tabindex="-1">
                ...
                <div class="tab-content"
                    style="padding: 0 !important; border: none !important; background: transparent !important;">
                    @can('mkt.penjualan')
                        <div class="tab-pane fade active show" id="penjualan" role="tabpanel">
                            <div class="card shadow-none border">
                                <div class="card-header border-bottom py-3"
                                    ...
                                    <h6 class="m-0 fw-bold text-white"><i class="ti ti-report-money me-2"></i>Laporan Penjualan
                                    </h6>
                                </div>
                    ...
                    @can('mkt.rekappenjualan')
                        <div class="tab-pane fade" id="rekappenjualan" role="tabpanel">
                            <div class="card shadow-none border">
                                <div class="card-header border-bottom py-3"
                                    style="background-color: #284c9a; border-radius: 0.375rem 0.375rem 0 0;">
                                    <h6 class="m-0 fw-bold text-white"><i class="ti ti-file-analytics me-2"></i>Rekap Penjualan
                                    </h6>
                                </div>
                                <div class="card-body pt-4">
                    ...
                    @can('mkt.rekappelanggan')
                        <div class="tab-pane fade" id="rekappelanggan" role="tabpanel">
                            <div class="card shadow-none border">
                                <div class="card-header border-bottom py-3"
                                    style="background-color: #284c9a; border-radius: 0.375rem 0.375rem 0 0;">
                                    <h6 class="m-0 fw-bold text-white"><i class="ti ti-user-exclamation me-2"></i>Rekap
                                        Pelanggan</h6>
                                </div>
                                <div class="card-body pt-4">
                    ...
                    @can('mkt.analisatransaksi')
                        <div class="tab-pane fade" id="analisatransaksi" role="tabpanel">
                            <div class="card shadow-none border">
                                <div class="card-header border-bottom py-3"
                                    style="background-color: #284c9a; border-radius: 0.375rem 0.375rem 0 0;">
                                    <h6 class="m-0 fw-bold text-white"><i class="ti ti-device-analytics me-2"></i>Analisa
                                        Transaksi</h6>
                                </div>
                                <div class="card-body pt-4">
                    ...
                    @can('mkt.tunaitransfer')
                        <div class="tab-pane fade" id="tunaitransfer" role="tabpanel">
                            <div class="card shadow-none border">
                                <div class="card-header border-bottom py-3"
                                    style="background-color: #284c9a; border-radius: 0.375rem 0.375rem 0 0;">
                                    <h6 class="m-0 fw-bold text-white"><i class="ti ti-arrows-transfer-down me-2"></i>Laporan
                                        Tunai Transfer</h6>
                                </div>
                                <div class="card-body pt-4">
                    ...
                    @can('mkt.effectivecall')
                        <div class="tab-pane fade" id="effectivecall" role="tabpanel">
                            <div class="card shadow-none border">
                                <div class="card-header border-bottom py-3"
                                    style="background-color: #284c9a; border-radius: 0.375rem 0.375rem 0 0;">
                                    <h6 class="m-0 fw-bold text-white"><i class="ti ti-phone-check me-2"></i>Laporan Effective
                                        Call</h6>
                                </div>
                                <div class="card-body pt-4">
                    ...
                    @can('mkt.kartupiutang')
                        <div class="tab-pane fade" id="kartupiutang" role="tabpanel">
                            <div class="card shadow-none border">
                                <div class="card-header border-bottom py-3"
                                    style="background-color: #284c9a; border-radius: 0.375rem 0.375rem 0 0;">
                                    <h6 class="m-0 fw-bold text-white"><i class="ti ti-address-book me-2"></i>Laporan Kartu
                                        Piutang</h6>
                                </div>
                                <div class="card-body pt-4">
                    ...
                    @can('mkt.lebihsatufaktur')
                        <div class="tab-pane fade" id="lebihsatufaktur" role="tabpanel">
                            <div class="card shadow-none border">
                                <div class="card-header border-bottom py-3"
                                    style="background-color: #284c9a; border-radius: 0.375rem 0.375rem 0 0;">
                                    <h6 class="m-0 fw-bold text-white"><i class="ti ti-files me-2"></i>Laporan Lebih 1 Faktur
                                    </h6>
                                </div>
                                <div class="card-body pt-4">
                    ...
                    @can('mkt.salesperfomance')
                        <div class="tab-pane fade" id="salesperfomance" role="tabpanel">
                            <div class="card shadow-none border">
                                <div class="card-header border-bottom py-3"
                                    style="background-color: #284c9a; border-radius: 0.375rem 0.375rem 0 0;">
                                    <h6 class="m-0 fw-bold text-white"><i class="ti ti-chart-infographic me-2"></i>Sales
                                        Performance</h6>
                                </div>
                                <div class="card-body pt-4">
                    ...
                    @can('mkt.persentasesfa')
                        <div class="tab-pane fade" id="persentasesfa" role="tabpanel">
                            <div class="card shadow-none border">
                                <div class="card-header border-bottom py-3"
                                    style="background-color: #284c9a; border-radius: 0.375rem 0.375rem 0 0;">
                                    <h6 class="m-0 fw-bold text-white"><i class="ti ti-device-mobile me-2"></i>Persentase SFA
                                    </h6>
                                </div>
                                <div class="card-body pt-4">
                    ...
                    @can('mkt.persentasesfa')
                        <div class="tab-pane fade" id="persentasedatapelanggan" role="tabpanel">
                            <div class="card shadow-none border">
                                <div class="card-header border-bottom py-3"
                                    style="background-color: #284c9a; border-radius: 0.375rem 0.375rem 0 0;">
                                    <h6 class="m-0 fw-bold text-white"><i class="ti ti-database me-2"></i>Persentase Data
                                        Pelanggan</h6>
                                </div>
                                <div class="card-body pt-4">
                    ...
                    @can('mkt.komisisalesman')
                        <div class="tab-pane fade" id="komisisalesman" role="tabpanel">
                            <div class="card shadow-none border">
                                <div class="card-header border-bottom py-3"
                                    style="background-color: #284c9a; border-radius: 0.375rem 0.375rem 0 0;">
                                    <h6 class="m-0 fw-bold text-white"><i class="ti ti-user-dollar me-2"></i>Komisi Salesman
                                    </h6>
                                </div>
                                <div class="card-body pt-4">
