                ...
                <tbody>
                    ...
                    @foreach ($komisi as $d)
                        ...
                        <tr>
                            ...
                            <td class="center">
                                @php
                                    $persentase_ro = !empty($d->realisasi_oa3bulan)
                                        ? ($d->realisasi_oa / $d->realisasi_oa3bulan) * 100
                                        : 0;
                                @endphp
                ...
                <tfoot>
                    @if ($cabang->kode_cabang == 'BDG')
                        ...
                        <tr>
                            ...
                            <th class="right">
                                @php
                                    $total_reward_spv =
                                        $reward_qty_spv + $reward_penjvsavg_spv + $reward_cashin_spv + $reward_ljt_spv;
                                @endphp
                    ...
                    <tr>
                        ...
                        @foreach ($kategori_komisi as $k)
                            ...
                            <th>
                                @php
                                    $ratiopoinsmm = !empty(${"total_realisasi_$k->kode_kategori"})
                        ...
                        <th class="right">
                            @php
                                $total_reward_smm =
                                    $reward_qty_smm + $reward_penjvsavg_smm + $reward_cashin_smm + $reward_ljt_smm;
                            @endphp
