...
<head>
    ...
    <title>Rekap Penjualan Qty per Regional Multi Tahun {{ date('Y-m-d H:i:s') }}</title>
...
<body>
    <div class="header">
        <h4 class="title">
            REKAP PENJUALAN QTY PER REGIONAL MULTI TAHUN <br>
        </h4>
        ...
        <table class="datatable3">
            <thead>
                <tr>
                    ...
                    <th rowspan="3" style="vertical-align: middle;">Regional</th>
                    ...
                    <tr>
                        ...
                        @foreach ($years as $year)
                            @foreach ($produk as $p)
                                @for ($m = 1; $m <= 12; $m++)
                                    @php
                                        $qty = $qty_map[$reg->kode_regional][$p->kode_produk][$year][$m] ?? 0;
