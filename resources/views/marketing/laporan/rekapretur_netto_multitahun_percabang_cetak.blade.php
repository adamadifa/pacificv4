...
<head>
    ...
    <title>Rekap Retur Netto per Cabang Multi Tahun {{ date('Y-m-d H:i:s') }}</title>
...
<body>
    <div class="header">
        <h4 class="title">
            REKAP RETUR NETTO PER CABANG MULTI TAHUN <br>
        </h4>
                ...
                @foreach ($cabang_list as $cb)
                    <tr>
                        ...
                        @foreach ($years as $year)
                            ...
                            @for ($m = 1; $m <= 12; $m++)
                                @php
                                    $retur = $retur_map[$cb->kode_cabang][$year][$m] ?? 0;
                                    $grand_totals[$year][$m] += $retur;
                                    $total_cabang_year += $retur;
                                @endphp
