...
<head>
    ...
    <title>Rekap Penjualan Omset Multi Tahun {{ date('Y-m-d H:i:s') }}</title>
...
<body>
    <div class="header">
        <h4 class="title">
            REKAP PENJUALAN OMSET MULTI TAHUN <br>
        </h4>
                ...
                @foreach ($salesmen as $salesman)
                    <tr>
                        ...
                        @foreach ($years as $year)
                            ...
                            @for ($m = 1; $m <= 12; $m++)
                                @php
                                    $netto = $netto_map[$salesman->kode_salesman][$year][$m] ?? 0;
                                    $grand_totals[$year][$m] += $netto;
                                    $total_salesman_year += $netto;
                                @endphp
