...
<head>
    ...
    <title>Rekap Retur Netto Multi Tahun {{ date('Y-m-d H:i:s') }}</title>
...
<body>
    <div class="header">
        <h4 class="title">
            REKAP RETUR NETTO MULTI TAHUN <br>
        </h4>
                ...
                @foreach ($salesmen as $salesman)
                    <tr>
                        ...
                        @foreach ($years as $year)
                            ...
                            @for ($m = 1; $m <= 12; $m++)
                                @php
                                    $retur = $retur_map[$salesman->kode_salesman][$year][$m] ?? 0;
                                    $grand_totals[$year][$m] += $retur;
                                    $total_salesman_year += $retur;
                                @endphp
