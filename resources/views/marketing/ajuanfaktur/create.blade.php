<form action="{{ route('ajuanfaktur.store') }}" aria-autocomplete="false" id="formAjuanfaktur" method="POST"
   ...
   <div class="input-group mb-3">
      <input type="text" class="form-control" name="kode_pelanggan" id="kode_pelanggan" readonly
         placeholder="Kode Pelanggan" aria-label="Cari Pelanggan" aria-describedby="kode_pelanggan_search">
   ...
   <div class="row mt-2">
      <div class="col-12">
         <div class="form-check mt-3 mb-2">
            <input class="form-check-input cod" name="cod" value="1" type="checkbox"
               id="cod">
