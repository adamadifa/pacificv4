...
@section('navigasi')
    <div class="d-flex justify-content-between align-items-center">
        <div>
            ...
            <small class="text-muted">Buat alur approval baru untuk ajuan faktur.</small>
        </div>
...
<div class="row">
    <div class="col-md-8">
        <form action="{{ route('ajuanfakturconfig.store') }}" method="POST">
            @csrf
    ...
    <div class="col-md-4">
        <div class="alert alert-info d-flex" role="alert">
            ...
            <div class="d-flex flex-column ps-1">
                ...
                <span>1. Tambahkan role sesuai urutan approval yang diinginkan.</span>
                <span>2. Alur persetujuan akan mengikuti urutan role yang didaftarkan.</span>
