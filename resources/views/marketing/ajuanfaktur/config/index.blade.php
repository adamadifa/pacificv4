@extends('layouts.app')
@section('titlepage', 'Konfigurasi Approval Ajuan Faktur')

@section('content')
@section('navigasi')
    <div class="d-flex justify-content-between align-items-center">
        <div>
            <h4 class="mb-0">Konfigurasi Approval Ajuan Faktur</h4>
            <small class="text-muted">Kelola alur urutan persetujuan ajuan faktur.</small>
        </div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0" style="font-size: 13px">
                ...
                <li class="breadcrumb-item">
                    <a href="{{ route('ajuanfaktur.index') }}">Ajuan Faktur Kredit</a>
                </li>
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div class="d-flex gap-2">
                @can('ajuanfaktur.config')
                    <a href="{{ route('ajuanfakturconfig.create') }}" class="btn btn-primary shadow-sm">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-2">
                            <div class="action-buttons-compact justify-content-end">
                                @can('ajuanfaktur.config')
                                    <a href="{{ route('ajuanfakturconfig.edit', $d->id) }}" class="btn-action-sm btn-edit-sm" title="Edit">
                                        <i class="ti ti-edit"></i>
                                    </a>
                                    <form method="POST" action="{{ route('ajuanfakturconfig.destroy', $d->id) }}" class="d-inline">
                                        @csrf
                                        @method('DELETE')
    ...
    @empty
        <div class="col-12">
            <div class="empty-state-compact">
                ...
                <p class="text-muted mb-4 small">Tentukan alur persetujuan ajuan faktur.</p>
                @can('ajuanfaktur.config')
                    <a href="{{ route('ajuanfakturconfig.create') }}" class="btn btn-primary">
