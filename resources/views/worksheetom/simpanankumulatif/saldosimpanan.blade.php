@extends('layouts.app')
@section('titlepage', 'Saldo Simpanan Kumulatif')

@section('content')
@section('navigasi')
    <span>Saldo Simpanan Kumulatif</span>
@endsection
<div class="row">
...
<script>
    $(function() {
        $(document).on('click', '.btnShow', function(e) {
            ...
            $("#modal").modal("show");
            $("#modal").find(".modal-title").text('Detail Simpanan Kumulatif');
            $("#modal").find("#loadmodal").load(
                `/pencairanprogram/${kode_pelanggan}/getdetailsimpanan`);
        });
        ...
        $(document).on('click', '.btnCairkan', function(e) {
            ...
            let kode_pelanggan = $(this).attr('kode_pelanggan');
            $("#modal").modal("show");
            $("#modal").find(".modal-title").text('Cairkan Simpanan Kumulatif');
            $("#modal").find("#loadmodal").load(
                `/pencairanprogram/${kode_pelanggan}/createpencairansimpanan`);
        });
    });
</script>
@endpush
