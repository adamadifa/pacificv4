<form action="{{ route('pencairanprogram.storeapprovepencairansimpanan', Crypt::encrypt($pencairansimpanan->kode_pencairan)) }}" method="POST"
    ...
    <div class="row mt-2">
        ...
        <div class="col">
            <button class="btn btn-danger w-100" id="btnSimpan" name="cancel" value="1"><i
                    class="ti ti-thumb-down me-1"></i>Batalkan</button>
        </div>
    </div>
</form>
<script>
