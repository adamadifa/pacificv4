@extends('layouts.app')
@section('titlepage', 'Atur Ajuan Program Ikatan Enambulan')

@section('content')
@section('navigasi')
    <span>Atur Ajuan Program Ikatan Enambulan</span>
@endsection
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between">
                    <a href="{{ route('ajuanprogramenambulan.index') }}" class="me-1 btn btn-danger">
