<form action="#" method="POST" id="formMutasiDPB" autocomplete="off" aria-autocomplete="none">
    @csrf
    <div class="row mb-2">
        <div class="col">
    ...
    <div class="row">
        <div class="col">
            <button type="submit" class="btn btn-primary w-100" id="submitMutasiDpb"><i class="ti ti-send me-1"></i>Submit</button>
        </div>
    </div>
</form>
<script>
