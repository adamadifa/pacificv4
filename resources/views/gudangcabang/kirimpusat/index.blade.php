...
@section('navigasi')
    <div class="d-flex justify-content-between align-items-center">
        <div>
            <h4 class="mb-0">Kirim Pusat</h4>
            <small class="text-muted">Kelola data pengiriman barang ke pusat.</small>
        </div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0" style="font-size: 13px">
                ...
                <li class="breadcrumb-item active"><i class="ti ti-send me-1"></i>Kirim Pusat</li>
            </ol>
        </nav>
    </div>
@endsection
    ...
    <div class="col-lg-12 col-md-12 col-sm-12">
        ...
        <div class="card shadow-sm border mt-2">
            <div class="card-header border-bottom py-3" style="background-color: #002e65; border-radius: 0.375rem 0.375rem 0 0;">
                <div class="d-flex justify-content-between align-items-center">
                    <h6 class="m-0 fw-bold text-white"><i class="ti ti-send me-2"></i>Data Kirim Pusat</h6>
