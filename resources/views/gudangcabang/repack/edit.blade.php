<form action="{{ route('repackcbg.update', Crypt::encrypt($repack->no_mutasi)) }}" method="POST" id="formRepack" autocomplete="off" aria-autocomplete="none">
   @csrf
   @method('PUT')
   <div class="row mb-2">
      <div class="col">
...
<script>
   $(function() {
      ...
      $(document).on('submit', '#formRepack', function(e) {
