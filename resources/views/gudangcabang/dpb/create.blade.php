<form action="{{ route('dpb.store') }}" method="POST" id="formDPB" autocomplete="off" aria-autocomplete="none">
   ...
   <div class="row">
      <div class="col-lg-8 col-md-12 col-sm-12">
         ...
         <x-input-with-icon icon="ti ti-calendar" label="Tanggal Pengambilan" name="tanggal_ambil"
               ...
               @foreach ($produk as $d)
                  ...
                  <tr>
                     ...
                     <td style="background-color:{{ $color }} ">
                        <input type="text" class="noborder-form text-end money" style="background-color: {{ $color }}" name="jml_pack[]"
