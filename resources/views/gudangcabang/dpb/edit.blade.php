            ...
            <div class="col">
                        ...
                        <tr id="index_{{ $dh->kode_driver_helper }}">
                           ...
                           <td style="width: 20%">
                              <input type="text" class="noborder-form text-end qtyhelper"
                                 name="qtyhelper[]" value="{{ formatAngkaDesimal3($dh->jumlah) }}">
                           </td>
                           <td>
               ...
               <div class="form-group mb-3 mt-2">
                  <select name="jenis_perhitungan" id="jenis_perhitungan" class="form-select">
                     ...
                     <option value="P" {{ $dpb->jenis_perhitungan == 'P' ? 'selected' : '' }}>Persentase</option>
                     <option value="Q" {{ $dpb->jenis_perhitungan == 'Q' ? 'selected' : '' }}>Quantity</option>
                     <option value="R" {{ $dpb->jenis_perhitungan == 'R' ? 'selected' : '' }}>Dibagi Rata</option>
                  </select>
               </div>
            </div>
         </div>
...
<script>
   $(function() {
      ...
      function generateqtyhelper() {
         ...
         if (jenis_perhitungan == "P") {
            qtyhelper.each(function() {
               let value = $(this).val();
               let persentase = parseFloat(value) / parseFloat(totalbarangkeluar) * 100;
            ...
            qtyhelper.each(function() {
               ...
               $(this).val(qtyhelper.toFixed(3));
            });
         }
      }

      $("#jenis_perhitungan").change(function(e) {
         generateqtyhelper();
      });
      generateqtyhelper();
      ...
      form.submit(function() {
         ...
         const jenis_perhitungan = form.find("#jenis_perhitungan").val();
         const qtyhelper = form.find(".qtyhelper");
         const totalbarangkeluar = "{{ ROUND($totalbarangkeluar, 3) }}";
