   ...
   <div class="row">
      ...
      <div class="col-lg-8 col-sm-12 col-md-12">
         ...
         <div class="row">
            <div class="col-lg-4 col-md-12.col-sm-12  ">
               <div class="form-group mb-3">
                  <select name="kode_helper" id="kode_helper" class="form-select select2Kodehelper">
            ...
            <div class="col-lg-4 col-md-12 col-sm-12">
               <div class="form-group mb-3">
                  <select name="kode_perhitungan" id="kode_perhitungan" class="form-select">
            ...
            <div class="col-lg-3 col-md-12 col-sm-12">
               <x-input-with-icon label="Jumlah" name="persentase_helper" icon="ti ti-box" align="right" />
            </div>
                  ...
                  <tbody>
                     @foreach ($driverhelper as $dh)
                        <tr id="index_{{ $dh->kode_driver_helper }}">
                           ...
                           <td>{{ $dh->kode_posisi == 'D' ? 'DRIVER' : 'HELPER' }}</td>
                           <td style="width: 20%">
                              <input type="text" class="noborder-form text-end" name="qty" id="qty">
                           </td>
                           <td>
         ...
         <div class="row">
            <div class="col">
               <div class="form-check mt-3 mb-3">
                  ...
                  <label class="form-check-label" for="defaultCheck3">Qty Dibagi Rata ?</label>
               </div>
            </div>
         </div>
                  ...
                  <tr>
                     ...
                     <td style="background-color: #ea54552e">
                        <input type="text" style="background-color: #ffdcdc2e"
                           class="noborder-form text-end money" name="jml_keluar_dus[]"
                     ...
                     <td style="background-color: #ea54552e">
                        <input type="text" style="background-color: #ffdcdc2e"
                           class="noborder-form text-end money" name="jml_keluar_pcs[]"
