            ...
            <tr>
              ...
              <td style="background-color: #ea54552e">
                <input type="text" style="background-color: #ffdcdc2e"
                  ...
                  id="jml_keluar_dus" value="{{ formatAngka($keluar_dus) }}">
              </td>
              <td style="background-color: {{ $color_keluar }}">
                <input type="text" style="background-color: #ffdcdc2e"
                  ...
                  id="jml_keluar_pack" value="{{ formatAngka($keluar_pack) }}">
              </td>
              <td style="background-color: #ea54552e">
                <input type="text" style="background-color: #ffdcdc2e"
              ...
              <td class="text-end">
                ...
                {{ formatAngkaDesimal3($barangkeluar_dus) }}
                <span class="showDesimalbarangkeluar"></span>
              </td>
            </tr>
          @endforeach
        <tfoot>
          <tr>
            ...
            <th class="text-end">
              ...
              <span id="showTotalbarangkeluar" style="font-size: 16px !important; font-weight:bold">{{ formatAngkaDesimal3($totalbarangkeluar) }}</span>
            </th>
          </tr>
        </tfoot>
        </tbody>
