...
<ul class="nav nav-tabs" role="tablist">
    <li class="nav-item" role="presentation">
        <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab" data-bs-target="#detaildpb"
            aria-controls="detaildpb" aria-selected="true">
...
<div class="tab-content">
                ...
                <table class="table table-bordered table-hover">
                    <thead class="table-dark">
                        ...
                        <tr>
                            ...
                            <th colspan="3" class="text-center bg-success">{!! !empty($dpb->tanggal_kembali)
                                ? DateToIndo($dpb->tanggal_kembali)
                                : '<span class="badge bg-warning">Waiting</span>' !!} </th>
                        </tr>
                        <tr>
                            <th>Dus / Ball</th>
                            <th>Pack</th>
                    ...
                    <tbody>
                        @foreach ($detail as $d)
                            ...
                            <tr>
                                ...
                                <td class="text-center" style="background-color:#28c76f1a">
                                ...
                                <td class="text-center" style="background-color: #ea54552e">
                        ...
                        <tbody>
                            @foreach ($mutasi_dpb as $d)
                                @php
                                    ...
                                    $hutangkirim = explode(
                                        '|',
                                        convertToduspackpcs($d->kode_produk, $d->jml_hutangkirim),
                                    );
                                    ...
                                    $gantibarang = explode(
                                        '|',
                                        convertToduspackpcs($d->kode_produk, $d->jml_gantibarang),
                                    );
    ...
    <div class="tab-pane fade" id="mutasidpb" role="tabpanel">
        <div class="row mb-2">
            <div class="col">
                <a href="#" class="btn btn-primary" id="btnCreatemutasidpb"><i
                        class="ti ti-plus me-1"></i>Tambah Data Mutasi</a>
            </div>
        </div>
        <div class="row mb-2">
            <div class="col">
