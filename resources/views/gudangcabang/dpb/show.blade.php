...
<div class="tab-content">
    ...
    @can('mutasidpb.index')
        <div class="tab-pane fade" id="mutasidpb" role="tabpanel">
            ...
            <div class="row mb-2">
                <div class="col">
                    <x-select label="Jenis Mutasi" name="jenis_mutasi_search" :data="$jenis_mutasi" key="kode_jenis_mutasi"
                        textShow="jenis_mutasi" upperCase="true" select2="select2Jenismutasisearch" />
                </div>
            </div>
            <div class="row">
                <div class="col">
...
<script>
    $(function() {
        ...
        $(document).on("click", ".btnEditmutasidpb", function(e) {
            ...
            const no_mutasi = $(this).attr('no_mutasi');
            $("#modalMutasi").modal("show");
            $("#modalMutasi").find(".modal-title").text("Edit Mutasi");
