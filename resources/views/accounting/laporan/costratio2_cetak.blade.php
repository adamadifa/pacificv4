            ...
            <table class="datatable3" style="width: 120%">
                ...
                <tbody>
                    @foreach ($cabang as $c)
                        ...
                        @endphp
                    @endforeach
                    @foreach ($costratio as $key => $d)
                        @php
                            $kode_kategori = @$costratio[$key + 1]->kode_kategori;
                        @endphp
                        <tr>
                            ...
                            @foreach ($cabang as $c)
                                @php
                                    ...
                                    ${"total_biaya_kategori_$c->kode_cabang"} += $d->{"jmlbiaya_$c->kode_cabang"};
                                @endphp
                                    ...
                                    @if ($d->kode_kategori == 'C02')
                                        @php
                                            $total_biaya_kategori =
                                                ...
                                                $logistik->{"logistik_$c->kode_cabang"} +
                                                $bahan->{"bahan_$c->kode_cabang"};
                                        @endphp
                                    @else
                                        @php
                                            $total_biaya_kategori = ${"total_biaya_kategori_$c->kode_cabang"};
                                        @endphp
                                    @endif
