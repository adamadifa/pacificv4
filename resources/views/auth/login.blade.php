        ...
        <form id="login-form" class="space-y-5 relative z-20" action="{{ route('login') }}" method="POST">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="password" name="password" id="password" class="input-field w-full pl-11 pr-12 py-3 rounded-xl"
                        placeholder="••••••••" required>
                    <button type="button" onclick="togglePassword('password', 'toggle-icon')" class="absolute inset-y-0 right-0 pr-3.5 flex items-center text-gray-400 hover:text-gray-300">
                        <svg id="toggle-icon" class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
