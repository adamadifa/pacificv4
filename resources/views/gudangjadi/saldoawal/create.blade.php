@extends('layouts.app')
@section('titlepage', 'Buat Saldo Awal Gudang Jadi')

@section('content')
@section('navigasi')
    <span class="text-muted fw-light">Saldo Awal Gudang Jadi /</span> Buat Saldo Awal
@endsection
...
<div class="row">
    <div class="col-lg-5 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('sagudangjadi.store') }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-12">
    ...
    $(function() {
        ...
        function loaddetailsaldo() {
            ...
            if (bulan == "") {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('sagudangjadi.getdetailsaldo') }}",
                    data: {
                        _token: "{{ csrf_token() }}",
                        bulan: bulan,
                        tahun: tahun
