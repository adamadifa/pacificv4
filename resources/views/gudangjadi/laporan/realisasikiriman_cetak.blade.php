            ...
            <tr>
              ...
              @foreach ($produk as $p)
                @php
                  ...
                  ${"total_persentase_$p->kode_produk"} = ${"total_permintaan_$p->kode_produk"} != 0 ? (${"total_realisasi_$p->kode_produk"} / ${"total_permintaan_$p->kode_produk"}) * 100 : 0;
                  $persentase = $d->{"permintaan_$p->kode_produk"} != 0 ? ($d->{"realisasi_$p->kode_produk"} / $d->{"permintaan_$p->kode_produk"}) * 100 : 0;
                @endphp
