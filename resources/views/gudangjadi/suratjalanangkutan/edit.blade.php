<form action="{{ route('suratjalanangkutan.update', Crypt::encrypt($suratjalanangkutan->no_dok)) }}" id="formSuratjalanangkutan" method="POST">
    @method('PUT')
    @csrf
    <x-input-with-icon label="No. dok" icon="ti ti-barcode" name="no_dok" value="{{ $suratjalanangkutan->no_dok }}" hideLabel="true" />
    <x-select label="Tujuan" name="kode_tujuan" :data="$tujuan" key="kode_tujuan" textShow="tujuan" upperCase="true"
        selected="{{ $suratjalanangkutan->kode_tujuan }}" select2="select2Kodetujuan" hideLabel="true" />
    <x-input-with-icon label="No. Polisi" name="no_polisi" icon="ti ti-truck" value="{{ $suratjalanangkutan->no_polisi }}" hideLabel="true" />
    ...
    <x-select label="Angkutan" name="kode_angkutan" :data="$angkutan" key="kode_angkutan" textShow="nama_angkutan" upperCase="true"
        selected="{{ $suratjalanangkutan->kode_angkutan }}" select2="select2Kodeangkutan" hideLabel="true" />
