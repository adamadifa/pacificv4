    ...
    <div class="row">
        <div class="col-4 text-center">
            @if (!empty($presensi->foto_in))
                <img src="{{ asset('storage/uploads/absensi/' . $presensi->foto_in) }}" class="card-img rounded thumbnail"
                    alt="">
            @else
    ...
    <div class="row">
        <div class="col-4 text-center">
            @if (!empty($presensi->foto_out))
                <img src="{{ asset('storage/uploads/absensi/' . $presensi->foto_out) }}" class="card-img rounded thumbnail"
                    alt="">
            @else
