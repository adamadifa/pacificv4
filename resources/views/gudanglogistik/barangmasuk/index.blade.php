...
@section('navigasi')
    <div class="d-flex justify-content-between align-items-center">
        <div>
            <h4 class="mb-0">Barang Masuk Gudang Logistik</h4>
            <small class="text-muted">Mengelola data barang masuk ke gudang logistik.</small>
        </div>
                ...
                <table class="table table-hover table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="text-white" style="background-color: #284c9a !important; width:30%">SUPPLIER</th>
