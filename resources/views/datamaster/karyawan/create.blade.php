<form action="{{ route('karyawan.store') }}" id="formcreateKaryawan" method="POST" enctype="multipart/form-data">
   ...
   <div class="row">
      <div class="col-lg-6 col-sm-12 col-md-12">
         <x-select-label label="Status Perkawinan" name="kode_status_kawin" :data="$status_perkawinan" key="kode_status_kawin"
            textShow="keterangan_status_kawin" kode="true" />
      </div>
      <div class="col-lg-6 col-sm-12 col-md-12">
         <div class="form-group mb-3">
   ...
   <div class="row">
      ...
      <div class="col-lg-6 col-sm-12 col-md-12">
         <x-select-label label="Group" name="kode_group" :data="$group" key="kode_group" textShow="nama_group"
            upperCase="true" />
      </div>
   </div>
   <div class="row">
      ...
      <div class="col-lg-6 col-sm-12 col-md-12">
         <x-select-label label="Klasifikasi" name="kode_klasifikasi" :data="$klasifikasi" key="kode_klasifikasi"
            textShow="klasifikasi" upperCase="true" />
      </div>
   </div>
