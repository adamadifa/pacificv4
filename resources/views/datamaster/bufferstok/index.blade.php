            ...
            <div class="card shadow-sm border mt-2">
                ...
                <div class="table-responsive text-nowrap">
                    <table class="table table-hover table-striped">
                        <thead>
                            <tr>
                                <th class="text-white" style="background-color: #284c9a !important;">KODE PRODUK</th>
                                <th class="text-white" style="background-color: #284c9a !important;">NAMA PRODUK</th>
                                <th class="text-white text-center" style="background-color: #284c9a !important;">BUFFER STOK</th>
                                <th class="text-white text-center" style="background-color: #284c9a !important;">MAX. STOK</th>
                            </tr>
                        </thead>
