...
@section('navigasi')
    <div class="d-flex justify-content-between align-items-center mb-0">
        <div>
            <h4 class="mb-0">Konfigurasi Approval</h4>
            <small class="text-muted">Rancang alur persetujuan penilaian karyawan secara dinamis.</small>
        </div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0" style="font-size: 13px">
                ...
                <li class="breadcrumb-item active">New Config</li>
            </ol>
        </nav>
    </div>
@endsection
