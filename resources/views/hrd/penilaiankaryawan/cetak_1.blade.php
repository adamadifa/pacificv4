                    ...
                    <tr>
                        <td style="width: 10%">
                            @if ($penilaiankaryawan->kode_perusahaan == 'MP')
                                <img src="{{ asset('assets/img/logo/mp.png') }}" width="80px" height="110px" alt="">
                            @endif
                        </td>
                        ...
                        @foreach ($penilaian_item as $d)
                            @if ($kode_kategori != $d->kode_kategori)
                                ...
                                <tr style="font-weight: bold">
                                    <td colspan="4" style="text-align: center; background-color:rgba(0, 255, 72, 0.235)">
                                        {{ $d->nama_kategori }}
                                    </td>
                                </tr>
                                <tr style="font-weight:bold">
                            ...
                            @if (!empty($d->jenis_kompetensi) && $jenis_kompetensi != $d->jenis_kompetensi)
                                <tr>
                                    <td colspan="3" style="text-align: center">
                                        {{ $d->jenis_kompetensi == 1 ? 'Kompentensi Wajib' : 'Kompetensi' }}
                                    </td>
                                </tr>
                            @endif
                            <tr>
