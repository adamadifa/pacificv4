            ...
            @if (isset($d[$tanggal_presensi]))
                ...
                @if ($d[$tanggal_presensi]['status'] == 'h')
                    ...
                    @php
                        ...
                        $potongan_jam_izin = 0;
                        $potongan_jam_pulangcepat = $d[$tanggal_presensi]['izin_pulang_direktur'] == '1' ? 0 : $pulangcepat['formatAngkaDesimal'];
                        $potongan_jam_izinkeluar =
                            $d[$tanggal_presensi]['izin_keluar_direktur'] == '1' || $izin_keluar['formatAngkaDesimal'] <= 1
                                ? 0
                                : $izin_keluar['formatAngkaDesimal'];
                        $potongan_jam_terlambat = $d[$tanggal_presensi]['izin_terlambat_direktur'] == '1' ? 0 : $terlambat['formatAngkaDesimal'];
            ...
            <div class="col">
                ...
                <table class="table">
                    ...
                    @if ($d['kategori_jabatan'] == 'MJ')
                        <tr>
                            <th>RUANG LINGKUP</th>
                            <td class="text-right">{{ formatRupiah($d['im_ruanglingkup']) }}</td>
                        </tr>
                        <tr>
                            <th>PENEMPATAN</th>
                            <td class="text-right">{{ formatRupiah($d['im_penempatan']) }}</td>
                        </tr>
                        <tr>
                            <th>KINERJA</th>
                            <td class="text-right">{{ formatRupiah($d['im_kinerja']) }}</td>
                        </tr>
                        <tr>
                            <th>KENDARAAN</th>
                            <td class="text-right">{{ formatRupiah($d['im_kendaraan']) }}</td>
                        </tr>
                    @else
                        <tr>
                            <th>MASA KERJA</th>
                            <td class="text-right">{{ formatRupiah($d['iu_masakerja']) }}</td>
                        </tr>
                        <tr>
                            <th>LEMBUR</th>
                            <td class="text-right">{{ formatRupiah($d['iu_lembur']) }}</td>
                        </tr>
                        <tr>
                            <th>PENEMPATAN</th>
                            <td class="text-right">{{ formatRupiah($d['iu_penempatan']) }}</td>
                        </tr>
                        <tr>
                            <th>KPI</th>
                            <td class="text-right">{{ formatRupiah($d['iu_kpi']) }}</td>
                        </tr>
                    @endif
