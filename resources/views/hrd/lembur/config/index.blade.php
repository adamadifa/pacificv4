@extends('layouts.app')
@section('titlepage', 'Config Approval Lembur')

@section('content')
@section('navigasi')
    <div class="d-flex justify-content-between align-items-center">
        <div>
            <h4 class="mb-0">Config Approval Lembur</h4>
            <small class="text-muted">Kelola hierarki dan alur persetujuan lembur sesuai unit organisasi.</small>
        </div>
...
<div class="row">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h5 class="mb-0 fw-bold"><i class="ti ti-settings me-2"></i>Konfigurasi Approval Lembur</h5>
            <div class="d-flex gap-2">
                @can('lembur.config.create')
                    <a href="{{ route('lemburconfig.create') }}" class="btn btn-primary">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-2">
                            <div class="action-buttons-compact justify-content-end">
                                @can('lembur.config.edit')
                                    <a href="{{ route('lemburconfig.edit', $d->id) }}" class="btn-action-sm btn-edit-sm" title="Edit">
                                        <i class="ti ti-edit"></i>
                                    </a>
                                @endcan
                                @can('lembur.config.delete')
                                    <form method="POST" name="deleteform" class="deleteform" action="{{ route('lemburconfig.destroy', $d->id) }}">
                                        @csrf
                                        @method('DELETE')
    ...
    @empty
        <div class="col-12">
            <div class="empty-state-compact">
                ...
                <p class="text-muted mb-4 small">Silahkan rancang alur persetujuan untuk lembur karyawan.</p>
                @can('lembur.config.create')
                    <a href="{{ route('lemburconfig.create') }}" class="btn btn-primary">
                        Mulai Sekarang
                    </a>
