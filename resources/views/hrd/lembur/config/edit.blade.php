@extends('layouts.app')
@section('titlepage', 'Edit Konfigurasi Approval Lembur')

@section('content')
@section('navigasi')
    <div class="d-flex justify-content-between align-items-center">
        <div>
            <h4 class="mb-0">Edit Konfigurasi Approval Lembur</h4>
            <small class="text-muted">Ubah alur persetujuan lembur karyawan.</small>
        </div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0" style="font-size: 13px">
                ...
                <li class="breadcrumb-item active"><i class="ti ti-edit me-1"></i>Edit</li>
            </ol>
        </nav>
    </div>
@endsection
...
<form action="{{ route('lemburconfig.update', $config->id) }}" method="POST" id="formConfig">
    @csrf
    @method('PUT')
    <div class="row g-4">
