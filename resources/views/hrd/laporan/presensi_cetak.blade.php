                                        ...
                                        <td style="padding: 10px; background-color: {{ $color }}; color: {{ $textcolor }} !important">
                                            ...
                                            @php
                                                ...
                                                $potongan_jam_pulangcepat =
                                                    $d[$tanggal_presensi]['izin_pulang_direktur'] == '1' || ($tanggal_presensi >= '2026-03-21' && $pulangcepat['desimal'] < 1 && !empty($d[$tanggal_presensi]['kode_izin_pulang'])) ? 0 : $pulangcepat['desimal'];
                                            ...
                                            <!-- Total Jam Kerja -->
                                            <p style="margin:0">
                                                <span style="font-weight: bold ;color: {{ !empty($textcolor) ? $textcolor : '#024a0d' }}">Total
                                                    Jam
                                                    :{{ $total_jam }}</span>
                                            </p>
                                            @if (!empty($ceklembur))
