...
@section('navigasi')
    <div class="d-flex justify-content-between align-items-center">
        <div>
            <h4 class="mb-0">Izin Cuti</h4>
            <small class="text-muted">Pengajuan Izin Cuti Karyawan</small>
        </div>
    ...
    <div class="col-12">
        ...
        <div class="card shadow-sm border mt-2">
            <div class="card-header border-bottom py-3" style="background-color: #002e65; border-radius: 0.375rem 0.375rem 0 0;">
                <div class="d-flex justify-content-between align-items-center">
                    <h6 class="m-0 fw-bold text-white"><i class="ti ti-calendar-event me-2"></i>Data Izin Cuti</h6>
                    @can('izincuti.create')
                ...
                <table class="table table-hover table-striped text-nowrap">
                    <thead style="background-color: #002e65;">
                        <tr>
                            ...
                            <th class="text-white">Jenis Cuti</th>
                            <th class="text-white">Lama</th>
                            <th class="text-white text-center"><i class="ti ti-paperclip"></i></th>
                                ...
                                <td class="text-center">
                                    @if (!empty($d->doc_cuti))
                                        @if (Storage::disk('public')->exists('/uploads/cuti/' . $d->doc_cuti))
                                            <a href="{{ getfileCuti($d->doc_cuti) }}" target="_blank" data-bs-toggle="tooltip"
                                                title="Lihat Dokumen">
                                                <i class="ti ti-paperclip fs-5"></i>
                                            </a>
                                        @else
                                            <i class="ti ti-error-404 text-danger fs-5" data-bs-toggle="tooltip"
                                                title="File tidak ditemukan"></i>
                                        @endif
                                    @else
                                        <i class="ti ti-x text-danger fs-5" data-bs-toggle="tooltip" title="Tidak ada dokumen"></i>
                                    @endif
                                </td>
                                <td class="text-center">
                                    @if (empty($d->head))
                                ...
                                <td>
                                    <div class="d-flex justify-content-center gap-1">
                                        <a href="#" class="btnShow text-info"
                                            kode_izin_cuti="{{ Crypt::encrypt($d->kode_izin_cuti) }}" data-bs-toggle="tooltip"
                                            title="Detail">
