...
@section('navigasi')
    <div class="d-flex justify-content-between align-items-center">
        <div>
            <h4 class="mb-0">Izin Absen</h4>
            <small class="text-muted">Pengajuan Izin Tidak Masuk Kerja</small>
        </div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0" style="font-size: 13px">
                ...
                <li class="breadcrumb-item active">Izin Absen</li>
            </ol>
        </nav>
    </div>
@endsection
    ...
    <div class="col-12">
        ...
        <div class="card shadow-sm border mt-2">
            <div class="card-header border-bottom py-3" style="background-color: #002e65; border-radius: 0.375rem 0.375rem 0 0;">
                <div class="d-flex justify-content-between align-items-center">
                    <h6 class="m-0 fw-bold text-white"><i class="ti ti-file-description me-2"></i>Data Izin Absen</h6>
                ...
                <table class="table table-hover table-striped">
                    <thead style="background-color: #002e65;">
                        <tr>
                            ...
                            <th class="text-white text-center">Lama</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center gap-1">
                                        <a href="#" class="btnShow text-info" kode_izin="{{ Crypt::encrypt($d->kode_izin) }}"
                                            ...
                                            @if (in_array($level_user, $level_hrd))
                                                @if ($d->status == 0)
                                                    <a href="#" class="btnEdit text-success"
                                                        kode_izin = "{{ Crypt::encrypt($d->kode_izin) }}" data-bs-toggle="tooltip"
                                                        title="Edit">
