...
@section('navigasi')
    <div class="d-flex justify-content-between align-items-center">
        <div>
            <h4 class="mb-0">Izin Sakit</h4>
            <small class="text-muted">Pengajuan Izin Sakit Karyawan</small>
        </div>
    ...
    <div class="col-12">
        ...
        <div class="card shadow-sm border mt-2">
            <div class="card-header border-bottom py-3" style="background-color: #002e65; border-radius: 0.375rem 0.375rem 0 0;">
                <div class="d-flex justify-content-between align-items-center">
                    <h6 class="m-0 fw-bold text-white"><i class="ti ti-prescription me-2"></i>Data Izin Sakit</h6>
                ...
                <table class="table table-hover table-striped text-nowrap">
                    <thead style="background-color: #002e65;">
                        <tr>
                            ...
                            <th class="text-white text-center">SID</th>
                                ...
                                <td class="text-center">
                                    @if (!empty($d->doc_sid))
                                        @if (Storage::disk('public')->exists('/uploads/sid/' . $d->doc_sid))
                                            <a href="{{ getSid($d->doc_sid) }}" target="_blank" data-bs-toggle="tooltip"
                                                title="Lihat SID">
                                        ...
                                        @endif
                                    @else
                                        <i class="ti ti-x text-danger fs-5" data-bs-toggle="tooltip" title="Tidak ada SID"></i>
                                    @endif
                                </td>
                                <td class="text-center">
                                    @if (empty($d->head))
                                ...
                                <td>
                                    <div class="d-flex justify-content-center gap-1">
                                        <a href="#" class="btnShow text-info"
                                            kode_izin_sakit="{{ Crypt::encrypt($d->kode_izin_sakit) }}" data-bs-toggle="tooltip"
                                            title="Detail">
