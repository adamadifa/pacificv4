...
@section('navigasi')
    <div class="d-flex justify-content-between align-items-center">
        <div>
            <h4 class="mb-0">Izin Terlambat</h4>
            <small class="text-muted">Pengajuan Izin Terlambat Kantor</small>
        </div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0" style="font-size: 13px">
                ...
                <li class="breadcrumb-item active">Izin Terlambat</li>
            </ol>
        </nav>
    </div>
@endsection
    ...
    <div class="col-12">
        ...
        <div class="card shadow-sm border mt-2">
            <div class="card-header border-bottom py-3" style="background-color: #002e65; border-radius: 0.375rem 0.375rem 0 0;">
                <div class="d-flex justify-content-between align-items-center">
                    <h6 class="m-0 fw-bold text-white"><i class="ti ti-clock-stop me-2"></i>Data Izin Terlambat</h6>
                ...
                <table class="table table-hover table-striped text-nowrap">
                    <thead style="background-color: #002e65;">
                        <tr>
                            ...
                            <th class="text-white">Jam Terlambat</th>
                    ...
                    <tbody>
                        @foreach ($izinterlambat as $d)
                            <tr>
                                ...
                                <td>{{ $d->kode_cabang }}</td>
                                <td>{{ date('H:i', strtotime($d->jam_terlambat)) }}</td>
