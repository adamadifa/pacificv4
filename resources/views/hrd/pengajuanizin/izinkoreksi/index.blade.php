                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        @can('izinkoreksi.approve')
                                                            ...
                                                            @else
                                                                ...
                                                                @endphp
                                                                @if (in_array($d->kode_dept, $dept_access) || in_array($d->kode_dept, $dept_acess_2) || empty($dept_access))
                                                                    @if (in_array($d->kode_jabatan, $jabatan_access) || empty($jabatan_access) || in_array($d->kode_jabatan, $jabatan_access_2))
                                                                        @if (empty($d->head) && empty($d->hrd) && $d->status == 0)
                                                                            <a href="#" class="btnApprove me-1"
                                                                                kode_izin_koreksi="{{ Crypt::encrypt($d->kode_izin_koreksi) }}">
                                                                                <i class="ti ti-external-link text-success"></i>
