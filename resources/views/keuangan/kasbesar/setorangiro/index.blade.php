            ...
            <div class="card-body p-0">
                <form action="{{ route('setorangiro.index') }}">
                    ...
                    <div class="row g-2 align-items-end">
                        ...
                        @endrole
                        <div class="col-lg col-md-6">
                            <x-input-with-icon label="No. Giro" icon="ti ti-barcode" name="no_giro" value="{{ Request('no_giro') }}" hideLabel="true" />
                        </div>
                        <div class="col-lg col-md-6">
        ...
        <div class="card shadow-sm border">
            ...
            <div class="table-responsive text-nowrap">
                <table class="table table-hover table-bordered table-striped text-center align-middle">
                    <thead>
                        <tr>
                            <th class="text-white text-start" style="background-color: #284c9a !important;">NO. GIRO</th>
