                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($setoran_penjualan as $key => $d)
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end {{ $color_setoran_tunai }} text-white">{{ formatAngka($d->lhp_tunai) }}</td>
                                                <td class="text-end {{ $color_setoran_tagihan }} text-white">{{ formatAngka($d->lhp_tagihan) }}</td>
                                                ...
                                                <td class="text-end cursor-pointer" data-bs-toggle="popover" data-bs-placement="{{ $position }}"
                                                    data-bs-html="true" data-bs-content="{!! $kontenkertas !!}" title="Rincian Setoran Kertas"
                                                    data-bs-custom-class="popover-info">
                                                    {{ formatAngka($setoran_kertas) }}
                                                </td>
                                                <td class="text-end cursor-pointer" data-bs-toggle="popover" data-bs-placement="{{ $position }}"
                                                    data-bs-html="true" data-bs-content="{!! $kontenlogam !!}" title="Rincian Setoran Logam"
                                                    data-bs-custom-class="popover-info">{{ formatAngka($setoran_logam) }}</td>
                                            ...
                                            @if ($d->tanggal != $next_tanggal)
                                                <tr class="table-dark">
                                                    ...
                                                    <td class="text-end">{{ formatAngka($subtotal_setoran_logam) }}
                                                    </td>
                                                    <td class="text-end">{{ formatAngka($subtotal_setoran_giro) }}</td>
                                                    </td>
                                                    <td class="text-end">{{ formatAngka($subtotal_setoran_transfer) }}
                                                    </td>
                                                    <td class="text-end">{{ formatAngka($subtotal_setoran_lainnya) }}
                                                    <td class="text-end">{{ formatAngka($subtotal_total_setoran) }}
                                                    </td>
                                                </tr>
                                                @php
                                                    $subtotal_lhp_tunai = 0;
