...
@section('navigasi')
    <div class="d-flex justify-content-between align-items-center">
        <div>
            <h4 class="mb-0">Saldo Awal Kas Kecil</h4>
            <small class="text-muted">Manajemen saldo awal kas kecil bulanan.</small>
        </div>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12">
        ...
        <div class="card shadow-sm border">
            <div class="card-header border-bottom py-3"
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <h6 class="m-0 fw-bold text-white"><i class="ti ti-database-import me-2"></i>Data Saldo Awal Kas Kecil</h6>
                ...
                <table class="table table-hover table-bordered table-striped align-middle">
                    <thead class="table-dark">
                        <tr>
                            ...
                            <th class="text-white text-center" style="background-color: #284c9a !important;">CABANG</th>
                            <th class="text-white text-center" style="background-color: #284c9a !important;">JUMLAH</th>
                            <th class="text-white text-center" style="background-color: #284c9a !important; width: 5%;">AKSI</th>
                        </tr>
                    </thead>
                    <tbody>
