                ...
                <table class="table table-hover table-bordered align-middle">
                    <thead class="table-dark">
                        <tr>
                            ...
                            <th class="text-white text-center" style="background-color: #284c9a !important;">PELANGGAN</th>
                            <th class="text-white text-center col-keterangan" style="background-color: #284c9a !important;">KETERANGAN</th>
                            <th class="text-white text-center col-kode-akun" style="background-color: #284c9a !important;">KODE AKUN</th>
                            <th class="text-white text-center" style="background-color: #284c9a !important;">PRT</th>
                    ...
                    <tfoot class="table-dark">
                        <tr>
                            <td colspan="5" class="fw-bold text-center" style="background-color: #284c9a !important;">TOTAL</td>
