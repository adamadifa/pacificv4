<li
   class="menu-item {{ request()->is(['omancabang', 'omancabang/*', 'oman', 'oman/*', 'permintaankiriman', 'permintaankiriman/*', 'targetkomisi']) ? 'open' : '' }}">
   @if (auth()->user()->hasAnyPermission(['omancabang.index', 'oman.index', 'permintaankiriman.index', 'targetkomisi.index']))
      ...
      <ul class="menu-sub">
         ...
         @can(['targetkomisi.index'])
            <li
               class="menu-item {{ request()->is(['targetkomisi', 'targetkomisi/*']) ? 'active' : '' }}">
