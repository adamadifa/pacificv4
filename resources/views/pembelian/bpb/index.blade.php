        ...
        <div class="nav-align-top nav-tabs-shadow mb-4">
            <div class="tab-content">
                <div class="tab-pane fade active show" id="navs-justified-home" role="tabpanel">
                    ...
                    <div class="row mt-2">
                        <div class="col-12">
                            <form action="{{ route('bpbpembelian.index') }}">
                                <div class="row">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        {{-- @endcan --}}
                                                        @if (Auth::user()->id == '54' && $d->approve_gudang == '1')
                                                            <a href="{{ route('bpbpembelian.cetak', Crypt::encrypt($d->no_bpb)) }}"
                                                                target="_blank" class="me-2" title="Cetak">
