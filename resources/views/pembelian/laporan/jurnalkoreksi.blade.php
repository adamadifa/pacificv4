<form action="{{ route('laporanpembelian.cetakjurnalkoreksi') }}" method="POST" id="frmLapJurnalkoreksi" target="_blank">
    @csrf
    <div class="row">
...
@push('myscript')
    <script>
        $(function() {
            const frmLapJurnalkoreksi = $('#frmLapJurnalkoreksi');
            frmLapJurnalkoreksi.submit(function(e) {
