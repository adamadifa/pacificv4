<form action="{{ route('laporanpembelian.cetakrekapkontrabon') }}" method="POST" id="formRekapkontrabon" target="_blank">
    @csrf
    <div class="row">
...
@push('myscript')
    <script>
        $(function() {
            const frmRekapkontrabon = $('#formRekapkontrabon');
            frmRekapkontrabon.submit(function(e) {
