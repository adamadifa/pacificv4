                ...
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <x-input-with-icon label="Tanggal" name="tanggal" icon="ti ti-calendar" datepicker="flatpickr-datepmb" hideLabel="true" />
                            ...
                            <x-input-with-icon label="Jatuh Tempo" name="jatuh_tempo" icon="ti ti-calendar" datepicker="flatpickr-datepmb" hideLabel="true" />
                            <div class="form-group mb-3">
