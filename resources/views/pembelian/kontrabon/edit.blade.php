...
@section('navigasi')
    <span class="text-muted">Kontrabon</span> / <span>Edit Kontra Bon</span>
@endsection
<form action="{{ route('kontrabonpmb.update', Crypt::encrypt($kontrabon->no_kontrabon)) }}" method="POST" id="formKontrabon">
    @csrf
    @method('PUT')
    <div class="row">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody id="loadpembelian">
                                            @foreach ($detail as $item)
                                                <tr id="{{ removeSpecialCharacters($item->no_bukti) }}">
                                                    ...
                                                    <td class="text-end totalbayar">{{ formatAngkaDesimal($item->jumlah) }}</td>
                                                    <td>
                                                        <a href="#" id="{{ removeSpecialCharacters($item->no_bukti) }}" class="delete">
