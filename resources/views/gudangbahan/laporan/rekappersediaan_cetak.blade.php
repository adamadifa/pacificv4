        ...
        <thead>
          <tr>
            <th rowspan="4"
              style="width: 1%">NO</th>
            <th rowspan="4"
              style="width:1%">KODE</th>
            <th rowspan="4"
              style="width:10%">NAMA BARANG</th>
            <th rowspan="4"
              style="width: 1%">SATUAN</th>
          </tr>
          <tr>
            <th colspan="3"
              rowspan="2">SALDO AWAL</th>
            <th colspan="9"
              class="green">PEMASUKAN</th>
            <th colspan="18"
              class="red">PENGELUARAN</th>
            <th colspan="3"
              rowspan="2">SALDO AKHIR
            </th>
            <th colspan="3"
              rowspan="2">OPNAME STOK
            </th>
            <th colspan="2"
              rowspan="2">SELISIH</th>
          </tr>
          <tr bgcolor="red">
            <th colspan="3"
              class="green">PEMBELIAN</th>
            <th colspan="3"
              class="green">LAINNYA</th>
            <th colspan="3"
              class="green">RETUR PENGGANTI</th>
            <th colspan="3"
              class="red">PRODUKSI</th>
            <th colspan="3"
              class="red">SEASONING</th>
            <th colspan="3"
              class="red">PDQC</th>
            <th colspan="3"
              class="red">SUSUT</th>
