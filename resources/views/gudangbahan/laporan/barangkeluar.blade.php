<form method="POST" action="{{ route('laporangudangbahan.cetakbarangkeluar') }}" id="frmLaporanbarangkeluar"
    target="_blank">
    @csrf
    <div class="row">
        <div class="col">
            <x-select label="Semua Barang" name="kode_barang_keluar" :data="$barang" key="kode_barang"
                textShow="nama_barang" select2="select2Kodebarangkeluar" upperCase="true" />
