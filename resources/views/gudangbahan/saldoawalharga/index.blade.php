@extends('layouts.app')
@section('titlepage', 'Saldo Awal Harga Gudang Bahan')

@section('content')
@section('navigasi')
    <div class="d-flex justify-content-between align-items-center">
        <div>
            <h4 class="mb-0">Saldo Awal Harga Gudang Bahan</h4>
            <small class="text-muted">Manajemen saldo awal harga barang gudang bahan.</small>
        </div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0" style="font-size: 13px">
                ...
                <li class="breadcrumb-item active"><i class="ti ti-currency-dollar me-1"></i>Saldo Awal Harga</li>
            </ol>
        </nav>
    </div>
@endsection
...
<div class="row">
    <div class="col-lg-7 col-md-12 col-sm-12">
        ...
        {{-- Filter Section --}}
        <form action="{{ route('sahargagb.index') }}">
        ...
        <div class="card shadow-sm border">
            <div class="card-header border-bottom py-3"
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <h6 class="m-0 fw-bold text-white"><i class="ti ti-currency-dollar me-2"></i>Data Saldo Awal Harga</h6>
                    @can('sahargagb.create')
                        <a href="{{ route('sahargagb.create') }}" class="btn btn-primary btn-sm shadow-sm">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center gap-2">
                                        ...
                                        @endcan
                                        @can('sahargagb.delete')
                                            <form method="POST" name="deleteform" class="deleteform d-inline"
                                                action="{{ route('sahargagb.delete', Crypt::encrypt($d->kode_saldo_awal)) }}">
                                                @csrf
                                                @method('DELETE')
...
<x-modal-form id="modal" size="modal-lg" show="loadmodal" title="Detail Saldo Awal Harga" />
@endsection
@push('myscript')
...
<script>
   $(function() {
      ...
      $(".showSaldoawal").click(function(e) {
         ...
         e.preventDefault();
         $('#modal').modal("show");
         $("#loadmodal").load('/sahargagb/' + kode_saldo_awal + '/show');
      });
   });
</script>
@endpush
