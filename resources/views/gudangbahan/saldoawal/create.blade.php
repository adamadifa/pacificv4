@extends('layouts.app')
@section('titlepage', 'Buat Saldo Awal Gudang Bahan')

@section('content')
@section('navigasi')
    <span class="text-muted fw-light">Saldo Awal Gudang Bahan /</span> Buat Saldo Awal
@endsection
    ...
    $(function() {
        ...
        function loaddetailsaldo() {
            ...
            if (bulan == "") {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('sagudangbahan.getdetailsaldo') }}",
                    data: {
                        _token: "{{ csrf_token() }}",
                        bulan: bulan,
                        tahun: tahun
