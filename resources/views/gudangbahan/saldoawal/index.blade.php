@extends('layouts.app')
@section('titlepage', 'Saldo Awal Gudang Bahan')

@section('content')
@section('navigasi')
    <div class="d-flex justify-content-between align-items-center">
        <div>
            <h4 class="mb-0">Saldo Awal Gudang Bahan</h4>
            <small class="text-muted">Manajemen saldo awal stok gudang bahan.</small>
        </div>
...
<div class="row">
    <div class="col-lg-7 col-md-12 col-sm-12">
        ...
        {{-- Filter Section --}}
        <form action="{{ route('sagudangbahan.index') }}">
            ...
            <div class="card-header border-bottom py-3"
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    @can('sagudangbahan.create')
                        <a href="{{ route('sagudangbahan.create') }}" class="btn btn-primary btn-sm shadow-sm">
                                    ...
                                    <div class="d-flex justify-content-center gap-2">
                                        ...
                                        @can('sagudangbahan.delete')
                                            <form method="POST" name="deleteform" class="deleteform d-inline"
                                                action="{{ route('sagudangbahan.delete', Crypt::encrypt($d->kode_saldo_awal)) }}">
                                                @csrf
                                                @method('DELETE')
...
<script>
    $(function() {
        ...
        $(".showSaldoawal").click(function(e) {
            ...
            e.preventDefault();
            $('#modal').modal("show");
            $("#loadmodal").load('/sagudangbahan/' + kode_saldo_awal + '/show');
        });
    });
</script>
@endpush
