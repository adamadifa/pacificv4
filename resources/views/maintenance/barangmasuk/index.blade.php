...
@section('navigasi')
    <div class="d-flex justify-content-between align-items-center">
        <div>
            <h4 class="mb-0">Barang Masuk Maintenance</h4>
            <small class="text-muted">Mengelola data barang masuk maintenance.</small>
        </div>
                ...
                <table class="table table-hover table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="text-white" style="background-color: #284c9a !important;">SUPPLIER</th>
                            <th class="text-white text-center" style="background-color: #284c9a !important;">TGL PEMBELIAN</th>
                            <th class="text-white text-center" style="background-color: #284c9a !important;">TGL DITERIMA</th>
                    ...
                    <tbody class="table-border-bottom-0">
                        @foreach ($barangmasuk as $d)
                            <tr>
                                ...
                                <td class="text-center">{{ DateToIndo($d->tanggal) }}</td>
                                <td>
                                    <div class="d-flex justify-content-center gap-2">
                                        @can('barangmasukmtc.show')
