...
Route::middleware('auth')->group(function () {
    ...
    Route::controller(SaldoawalpiutangController::class)->group(function () {
        ...
        Route::post('/sapiutang', 'store')->name('sapiutang.store')->can('sapiutang.store');
        Route::delete('/sapiutang/{kode_saldo_awal}', 'destroy')->name('sapiutang.delete')->can('sapiutang.delete');
    ...
    Route::controller(CostratioController::class)->group(function () {
        ...
        Route::post('/costratio/syncnominal', 'syncnominal')->name('costratio.syncnominal')->can('costratio.index');
    });
    ...
    Route::controller(PresensiController::class)->group(function () {
        ...
        Route::get('/presensi/logerror', 'logerror')->name('presensi.logerror')->can('presensi.index');
        ...
        Route::post('/presensi/storekoreksipresensi', 'storekoreksipresensi')->name('presensi.storekoreksipresensi')->can('presensi.index');
        Route::get('/presensi/{id}/{status}/show', 'show')->name('presensi.show')->can('presensi.index');
        Route::delete('/presensi/{id}/delete', 'destroy')->name('presensi.delete')->can('presensi.index');
    });
    ...
    Route::controller(LaporankeuanganController::class)->group(function () {
        ...
        Route::post('/laporankeuangan/updatestatuspajakledgerbatch', 'updatestatuspajakledgerbatch')->name('laporankeuangan.updatestatuspajakledgerbatch');
    });
    ...
    Route::controller(PushSubscriptionController::class)->group(function () {
        Route::get('/push-subscriptions', 'index')->name('push-subscriptions.index')->can('push-subscriptions.index');
        Route::get('/push-subscriptions/{id}/test', 'test')->name('push-subscriptions.test')->can('push-subscriptions.test');
        Route::delete('/push-subscriptions/{id}', 'destroy')->name('push-subscriptions.destroy')->can('push-subscriptions.delete');
    });
    ...
    Route::controller(ProgramIkatan2026Controller::class)->group(function () {
        ...
        Route::get('/programikatan2026/{no_pengajuan}/{kode_pelanggan}/detailrealisasi', 'detailrealisasi')->name('programikatan2026.detailrealisasi');
    ...
    // Pencairan Program Ikatan 2026
    Route::controller(PencairanProgramIkatan2026Controller::class)->group(function () {
        Route::get('/pencairanprogramikatan2026', 'index')->name('pencairanprogramikatan2026.index')->can('pencairanprogramikatan2026.index');
        Route::get('/pencairanprogramikatan2026/create', 'create')->name('pencairanprogramikatan2026.create')->can('pencairanprogramikatan2026.create');
        Route::post('/pencairanprogramikatan2026/store', 'store')->name('pencairanprogramikatan2026.store')->can('pencairanprogramikatan2026.store');
        Route::get('/pencairanprogramikatan2026/{kode_pencairan}/setpencairan', 'setpencairan')->name('pencairanprogramikatan2026.setpencairan')->can('pencairanprogramikatan2026.edit');
        Route::get('/pencairanprogramikatan2026/{kode_pencairan}/tambahpelanggan', 'tambahpelanggan')->name('pencairanprogramikatan2026.tambahpelanggan')->can('pencairanprogramikatan2026.create');
        Route::post('/pencairanprogramikatan2026/getpelanggan', 'getpelanggan')->name('pencairanprogramikatan2026.getpelanggan')->can('pencairanprogramikatan2026.create');
        Route::post('/pencairanprogramikatan2026/{kode_pencairan}/storepelanggan', 'storepelanggan')->name('pencairanprogramikatan2026.storepelanggan')->can('pencairanprogramikatan2026.create');
        Route::delete('/pencairanprogramikatan2026/{kode_pencairan}/{kode_pelanggan}/deletepelanggan', 'deletepelanggan')->name('pencairanprogramikatan2026.deletepelanggan')->can('pencairanprogramikatan2026.delete');
