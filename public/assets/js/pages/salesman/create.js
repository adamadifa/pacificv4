(function () {
    const formcreateSalesman = document.querySelector('#formcreateSalesman');
    // Form validation for Add new record
    if (formcreateSalesman) {
        const fv = FormValidation.formValidation(formcreateSalesman, {
            fields: {
                kode_salesman: {
                    validators: {
                        notEmpty: {
                            message: 'Kode Salesman Harus Diisi'
                        },
                        stringLength: {
                            max: 7,
                            min: 7,
